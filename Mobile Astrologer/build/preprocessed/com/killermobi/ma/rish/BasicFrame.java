...
public int date,month,year,a,b,c;
     public BasicFrame(String name, String dob, int lifepath, int expression, int soulurge, int birthdate, char fl) {
        this.name = name;
        this.dob = dob;
...
// gives sum of date
        ...
        ta.setText(base.getBasicDetails(c));
    ...
    public boolean onMessage(Object o, Object[] os) {
        if ("next".equals(o)) {
            Kuix.getFrameHandler().pushFrame(new BasicMoreFrame(name, dob, lifepath, expression, soulurge, birthdate, fl));
            return false;
        }
