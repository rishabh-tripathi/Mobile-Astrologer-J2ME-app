 ...
 * @author rishabh
 */
public class MotiveSUFrame implements Frame {
    ...
    public MotiveSUFrame(String name, String dob, int lifepath, int expression, int soulurge, int birthdate, char fl) {
        this.name = name;
        this.dob = dob;
    ...
    public void onAdded() {
        ...
        t3.setText("You are apt to want");
        TextArea ta1 = (TextArea) screen.getWidget("details1");
        ta1.setText(ff.getMotive(soulurge));
         TextArea note = (TextArea) screen.getWidget("details3");
        note.setText("Note: [Your inner nature is usually revealed to others, but sometimes it is hidden within.]");
