 ...
 * @author rishabh
 */
public class BirthDateFrame implements Frame {
    ...
    public BirthDateFrame(String name, String dob, int lifepath, int expression, int soulurge, int birthdate, char fl) {
        this.name = name;
        this.dob = dob;
    ...
    public void onAdded() {
        ...
        t2.setText("Birth Date");
        birthdate ff = new birthdate();
        TextArea t3 = (TextArea) screen.getWidget("text3");
        t3.setText("Your birth date " + birthdate + " signifies,");
        TextArea ta1 = (TextArea) screen.getWidget("details1");
        ta1.setText(ff.getBirthDate(birthdate));
        screen.setCurrent();
    }
